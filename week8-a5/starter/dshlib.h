...
int parse_command_with_pipe(char *input, command_list_t *clist); // Function to parse commands with pipes
Built_In_Cmds match_command(const char *input);
Built_In_Cmds exec_built_in_cmd(cmd_buff_t *cmd);
void exec_cd(cmd_buff_t *cmd);
int parse_single_command(char *input, cmd_buff_t *cmd);
...
void exec_piped_cmds(command_list_t *cmd);
